/* ==============================================================================
   * 功能描述：WayBillReconciliationRepository  
   * 创 建 者：Zouqj
   * 创建日期：2015/6/3 14:36:37
   ==============================================================================*/
using System;
...
namespace Data.Reconciliation
{
    ...
    {
        public override ProjectBase.Utils.Entities.IPageOfList<WayBillReconciliation> GetByFilter(ParameterFilter filter)
        {
